function [pred_collect, RMSE] = res_train_predict_iter(in, test_in, resparams, jobid, locality, chunk_size, pred_marker_array, sync_length)


[x, w_out, w, w_in, RMSE] = train_reservoir_iter(resparams, in, labindex, jobid, locality, chunk_size);
