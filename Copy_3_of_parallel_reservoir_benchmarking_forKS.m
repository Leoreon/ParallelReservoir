...
%        tf = matfile('KS100/test_input_sequence.mat');
        ...
        resparams.N = nodes_per_input*(chunk_size_data+chunk_size_input+overlap_size_data+overlap_size_input); % exact number of nodes in the network
