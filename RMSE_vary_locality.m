...
for jobid = jobid_list
    ...
    plot(times(1,1:pred_length), errors(1, 1:pred_length), 'LineWidth', lineWidth, 'DisplayName', ['l=' num2str(locality)]); 
...
sgtitle(['RMSE L=' num2str(L) ', num_reservoirs: ' num2str(num_workers) ', Ntotal=' num2str(Ntotal)]);
