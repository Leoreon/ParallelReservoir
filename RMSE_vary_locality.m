...
L = 44; Ntotal = 10080; locality_list = 20:20:200; num_workers_list = 4:2:16; % locality_list = [20 25 30 35 40 45 50 55 60]; num_workers_list = [1 4 5 6 7 8 10]; % num_workers_list = [1 2 4 5 6 8 10 12];
...
xlabel('number of reservoirs'); ylabel('locality'); title('L=22');
colorbar; view(0, 90); fontsize(16, 'points');
