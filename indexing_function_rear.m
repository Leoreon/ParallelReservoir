function  rear_overlap = indexing_function_rear(chunk_begin, locality, num_inputs, chunk_size, data_kind, l)
switch data_kind
    case 'LCD'
        interval = 1;
        rear_overlap = chunk_begin-interval*locality:interval:chunk_begin-1;
        rear_overlap(rear_overlap<=0|rear_overlap>num_inputs) = [];
