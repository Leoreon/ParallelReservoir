function [pred_collect, RMSE] = res_train_predict(in, test_in, resparams, jobid, locality, chunk_size, pred_marker_array, sync_length, nodes_per_input)


[x, w_out, w, w_in, RMSE] = train_reservoir(resparams, in, labindex, jobid, locality, chunk_size, nodes_per_input);
toc
